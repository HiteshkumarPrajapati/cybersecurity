...
|-----------|-------------|
| ISO/IEC 42001:2023 | AI management system — third-party AI risk controls |
...
| **Model type** | Gradient Boosting + Neural Network ensemble — proprietary |
| **Certifications claimed** | ISO 27001 (claimed, scope unverified) |
| **SOC 2 report** | Not provided |
| **Client base** | 12 financial services clients — 3 in Australia, 9 offshore |
...
| Vendor data used for model improvement (standard terms) | Customer data use beyond primary purpose — APP 6 |
